...
-- Version 14.0: Fix site_finances to profiles relationship.
...
-- FIX: Correctly reference public.profiles(id) instead of auth.users(id) to establish a direct relationship.
...
SELECT 'Database setup complete! Version 14.0 (Fixed site_finances relationship)' as result;
`;
