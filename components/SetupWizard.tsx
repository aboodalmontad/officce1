            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl">
                <div className="text-center p-6 border-b bg-gray-50 rounded-t-xl">
                    ...
                    <p className="text-gray-600 mt-2 leading-relaxed">
                        تم ربط التطبيق بمشروع Supabase. الخطوة الأخيرة هي تهيئة قاعدة البيانات عن طريق إنشاء الجداول اللازمة.
                    </p>
                </div>
                ...
                <div className="p-8">
                    <div className="p-6 border rounded-lg border-blue-500 bg-blue-50">
                        <h4 className="text-xl font-bold text-gray-800 flex items-center">
                            <span className="flex items-center justify-center w-6 h-6 font-bold text-white bg-blue-600 rounded-full me-3">1</span>
                            تهيئة قاعدة البيانات
                        </h4>
                        <div className="mt-4 space-y-4 text-gray-700 animate-fade-in">
                            <p>للسماح للتطبيق بحفظ البيانات، تحتاج إلى إنشاء الجداول اللازمة في قاعدة بياناتك. لقد جهزنا لك كل ما تحتاجه.</p>
