...
const unifiedScript = `
-- =================================================================
-- السكربت الشامل والنهائي (الإصدار 26.0)
-- =================================================================
...
CREATE TABLE public.profiles (id uuid NOT NULL PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE, full_name text, mobile_number text, is_approved boolean DEFAULT false, is_active boolean DEFAULT true, subscription_start_date date, subscription_end_date date, role text DEFAULT 'user');
