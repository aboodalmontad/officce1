...
const appointmentSoundBase64 = 'data:audio/mpeg;base64,-';
...
export const defaultUserApprovalSoundBase64 = 'data:audio/mpeg;base64,';
        ...
        if (userApprovalAlerts.length > 0) {
            ...
            try {
                ...
                if (customSoundRaw) {
                    ...
                    if (typeof parsedSound === 'string' && parsedSound.startsWith('data:audio')) {
                        soundSource = parsedSound;
                    }
                }
            } catch (e) {
                console.error("Failed to parse custom sound from localStorage, using default.", e);
            }
